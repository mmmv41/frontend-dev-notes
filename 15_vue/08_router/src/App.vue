<template>
  <header>
    ...
    <div>
      <!-- 
        RouterLink
        1. to 속성을 쓰면 url 주소를 바꿔줌. (라우팅, location.href 속성을 바꾸는 것과 같은 작업(url 경로 수정))
        2. active-class 를 쓰면 사용자가 활성화한 버튼에 클래스명으로 css를 별도로 부여 가능
        3. replace 를 쓰면 뒤로 가기 버튼 막기 가능
      -->
...
<script setup>
  // RouterLink - 이동할 수 있는 태그 (기능이 있는 버튼 느낌)
